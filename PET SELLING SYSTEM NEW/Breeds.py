...
class Breed6:
    ...
    def detail(self):
        ...
        print("""if you want to view order or cancel order -
                               Send Email : petsellingnewborn@gmail.com                                    
                                    for eg:
                                     __________________________________________
                                           ...
                                           to,
                                                petsellingnewborn@gmail.com

                                           subject,
                                             (for view your orders)
                                                view my order:
                                                My order id - eg (labi012)
    ...
    def pets(self):
         ...
         if pets=="1":
                ...
                cats=input("""Cats lists:
                              ...
                              1.British shorthair - (Available-1 Male kitten)
                              2.Persian cat- (Available- 1 Male kitten)
